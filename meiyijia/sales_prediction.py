...
if __name__ == '__main__':
    ...
    parser.add_argument("-max_data",                    type=int, default=2000000)
    # model
    ...
    parser.add_argument('-result_dir',         type=str, default='year16_18_item_store_city_weather_weekday_onehot0_store')
        ...
        with open('results/%s.txt'%args.result_dir,'w') as args.outfiler:
            ...
            if args.func == 'main':
                if args.mode == 'lgb':
                    ...
                    # best_args = {}
                    # args.grid_search = 0
                    # for i in [0, 1]:#xrange(3, 9):
                    #     for j in [0, 1]:#xrange(3, 11):
                    #         args.lambda_l1 = i
                    #         args.lambda_l2 = j
                    ...
                    #             best_args['lambda_l1'] = args.lambda_l1
                    #             best_args['lambda_l2'] = args.lambda_l2
                    # print(best_args)
                else:
